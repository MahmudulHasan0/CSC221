...
public class Tip extends Application{
	...
	public void start(Stage stage){
		try {
			Parent root = FXMLLoader.load(getClass().getResource("Tip.fxml")); //1) Loading the fxml file by using the FXMLLoader class's static load method to create the GUI's scene graph. 
